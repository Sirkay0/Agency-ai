      ...
      className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        <div className="space-y-5 text-sm text-gray-700 dark:text-gray-400">
            ...
            <ul className="flex gap-8">
                ...
                <li><a className="hover:text-primary" href="#contact-us">Contect Us</a></li>
            </ul>
        </div>
        <motion.div 
        ...
        className="text-gray-600 dark:text-gray-400">
            ...
            <p className="text-sm mt-2 mb-6 ">The latest news, articles, and resourses, sent to your inbox weekly.</p>
